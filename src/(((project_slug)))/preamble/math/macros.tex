...
((* if "custom_macros" in math_options *))
...
\NewDocumentCommand{\cofib}{s}
  {\IfBooleanTF{#1}{\rightarrowtail}{\leftarrowtail}}
\NewDocumentCommand{\fib}{s}
  {\IfBooleanTF{#1}{\twoheadrightarrow}{\twoheadleftarrow}}
