...
%%   #3 - Chinese name
%%   #2 - options (optional)
\NewDocumentCommand{\DeclareTheoremEnv}{m m o}{
  \IfValueTF{#2}{
    \declarekeytheorem{#1}[#3, name=#2]
    \declarekeytheorem{#1*}[#3, name=#2, numbered=false]
  }{
    \declarekeytheorem{#1}[name=#2]
    \declarekeytheorem{#1*}[name=#2, numbered=false]
  }
}
((* else *))
%% Automatically generate starred unnumbered versions of environments
